                    ...
                    <div className="col-md-4">
                        <div className="me auto_height_item">
                            ...
                            <div className="social">
                                {about.content[translation.code].linkedin && <a title="Linkedin" href={about.content[translation.code].linkedin} target="_blank"><i className="lni lni-linkedin"></i></a>}
                                {about.content[translation.code].github && <a title="Github" href={about.content[translation.code].github} target="_blank"><i className="lni lni-github"></i></a>}
                                {about.content[translation.code].youtube && <a title="Youtube" href={about.content[translation.code].youtube} target="_blank"><i className="lni lni-youtube"></i></a>}
                                {about.content[translation.code].instagram && <a title="Instagram" href={about.content[translation.code].instagram} target="_blank"><i className="lni lni-instagram"></i></a>}
                            </div>
                        </div>
                    </div>
