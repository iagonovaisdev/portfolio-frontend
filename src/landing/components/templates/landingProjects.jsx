                        ...
                        <div className="col-md-12">
                            {categories.length >= 1 &&
                                <div className="list-categories">
                                    <div onClick={()=>changeCategory(null)} className={`category ${activeCategory === null ? 'active':''}`}>
                                        <span>Tudo</span>
                                    </div>
                                    {categories.map((category,id)=>
                                        <div key={id} onClick={()=>changeCategory(category._id)} className={`category ${category._id == activeCategory ? 'active':''}`}>
                                            <span>{category.content[translation.code].title}</span>
                                        </div>
                                    )}
                                </div>
                            }
                                            ...
                                            <div className="row">
                                                ...
                                                <div className="col-md-6">
                                                    <div className="content">
                                                        ...
                                                        <div className="link">
                                                            <a><i className="lni lni-zoom-in"></i> {translation.landing.projects.see}</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
