...
export default function PanelCertificates() {
    ...
    const getData = (limit = 15) => {
        PrivateApi.get('/certificates?page='+paginationActual+'&limit='+limit).then((result)=>{
            let newData = [];
    ...
    const deleteData = (id) => {
        if( confirm('Tem certeza que deseja deletar esse item?') ) {
            PrivateApi.delete('/certificates/'+id,{
                headers: {
    ...
    useEffect(()=>{
        ...
        Sortable.create(sortableParent,{
            ...
            onEnd: () => {
                ...
                PrivateApi.put('/certificates/reorder/',{'order':newOrder},{
                    headers: {
                        'authorization': auth.token
                    }
                })
                        ...
                        <div className="container">
                            ...
                            <div className="row flex flex-middle">
                                ...
                                <div className="col-md-6">
                                    ...
                                    <a href="/control/certificates/add" className="panel-content-button float-right">
