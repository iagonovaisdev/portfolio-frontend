...
export default function PanelCertificatesEdit() {
    ...
    const loadData = async () => {
        ...
        if(!id) return;
        await PrivateApi.get('/certificates/'+id)
        .then((result)=>{
            let updateData = {};
    ...
    const handleSubmit = async () => {
        ...
        setLoader(true);
        await PrivateApi.put('/certificates/update/'+id,data,{
            headers: {
                                            ...
                                            >
                                                ...
                                                <Tab eventKey="en_us" title="EN-US">
                                                    <PanelForm>
                                                        ...
                                                        <PanelField language="en_us" handleData={handleData} type='text' name='title' label='Título:' value={data['content']['en_us'].title}/>
                                                        <PanelField language="en_us" handleData={handleData} type='textarea' name='description' label='Descrição:' value={data['content']['en_us'].description}/>
                                                        <PanelField submit={handleSubmit} setLoader={setLoader} loader={loader} type='submit' value='Salvar'/>
                                                    </PanelForm>
                                                </Tab>
                                            </Tabs>
