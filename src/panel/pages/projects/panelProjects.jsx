    ...
    useEffect(()=>{
        ...
        Sortable.create(sortableParent,{
            ...
            onEnd: () => {
                ...
                PrivateApi.put('/projects/reorder/',{'order':newOrder},{
                    headers: {
                        'authorization': auth.token
                    }
                })
                        ...
                        <div className="container">
                            ...
                            <div className="row flex flex-middle">
                                ...
                                <div className="col-md-6">
                                    ...
                                    <a href="/control/projects/add" className="panel-content-button float-right">
                                                ...
                                                <tr id={item.id} key={i}>
                                                    ...
                                                    <td>
                                                        <div className="tabled-actions float-right">
                                                            <a title="Editar" href={`/control/projects/edit/${item.id}`}><i className="lni lni-pencil"></i></a>
