...
export default function PanelProjectsCategories() {
    ...
    const getData = (limit = 15) => {
        PrivateApi.get('/projects-categories?page='+paginationActual+'&limit='+limit).then((result)=>{
            let newData = [];
    ...
    const deleteData = (id) => {
        if( confirm('Tem certeza que deseja deletar esse item?') ) {
            PrivateApi.delete('/projects-categories/'+id,{
                headers: {
    ...
    useEffect(()=>{
        ...
        Sortable.create(sortableParent,{
            ...
            onEnd: () => {
                ...
                PrivateApi.put('/projects-categories/reorder/',{'order':newOrder},{
                    headers: {
                        'authorization': auth.token
                    }
                })
                        ...
                        <div className="container">
                            ...
                            <div className="row flex flex-middle">
                                ...
                                <div className="col-md-6">
                                    ...
                                    <a href="/control/projects/categories/add" className="panel-content-button float-right">
                                                ...
                                                <tr id={item.id} key={i}>
                                                    ...
                                                    <td>
                                                        <div className="tabled-actions float-right">
                                                            <a title="Editar" href={`/control/projects/categories/edit/${item.id}`}><i className="lni lni-pencil"></i></a>
