...
export default function PanelStackCategoryEdit() {
    ...
    const loadData = async () => {
        ...
        if(!id) return;
        await PrivateApi.get('/projects-categories/'+id)
        .then((result)=>{
            let updateData = {};
    ...
    const handleSubmit = async () => {
        ...
        setLoader(true);
        await PrivateApi.put('/projects-categories/update/'+id,data,{
            headers: {
                        ...
                        <div className="panel-middle">
                            ...
                            content={{
                                ...
                                "list":[
                                    ...
                                    {'title':'Categorias','href':'/control/projects/categories','active':''},
                                    {'title':'Editar','href':'/control/projects/categories/edit/'+id,'active':'true'}
                                ]
                            }}
                            />
