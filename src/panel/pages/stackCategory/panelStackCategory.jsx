...
export default function PanelStackCategory() {
    ...
    const getData = (limit = 15) => {
        PrivateApi.get('/stack-category?page='+paginationActual+'&limit='+limit).then((result)=>{
            let newData = [];
    ...
    const deleteData = (id) => {
        if( confirm('Tem certeza que deseja deletar esse item?') ) {
            PrivateApi.delete('/stack-category/'+id,{
                headers: {
    ...
    useEffect(()=>{
        ...
        Sortable.create(sortableParent,{
            ...
            onEnd: () => {
                ...
                PrivateApi.put('/stack-category/reorder/',{'order':newOrder},{
                    headers: {
                        'authorization': auth.token
                    }
                })
                        ...
                        <div className="container">
                            ...
                            <div className="row flex flex-middle">
                                ...
                                <div className="col-md-6">
                                    ...
                                    <a href="/control/stack/category/add" className="panel-content-button float-right">
